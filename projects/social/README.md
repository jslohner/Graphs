...
- You would need to call add_friendship() 500 times because 100 users with an average of 10 friends means there are a total of 1000 friends being generated, and when you call add_friendship, it adds the friend to the two people involved in the friendship. For example if you have 10 users and an average of 2 friends each, that means 20 total friends and adding user1 to user2's friend list also adds user2 to user1's friend list.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?
- After testing multiple times with 1000 users having an average of 5 random friends each, I got anywhere in-between [0.2% - 1%] of other users being in any particular user's network. The average degree of separation from what I found was in-between [3.8 - 4.3].
